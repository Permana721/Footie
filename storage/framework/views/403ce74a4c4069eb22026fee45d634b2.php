...
<div class="modal fade" id="addModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content modal-md" style="height: 1130px;">
        ...
        <div class="col-sm-5"></div>
          <div class="col-sm-7">
              <div class="foto-container-2">
                  ...
                  <!-- Tombol + -->
                  <label for="inputFoto2" class="plus-btn">
                      <i class="fas fa-plus"></i>
                      <input type="file" class="form-control d-none" accept=".png, .jpg, .jpeg" id="inputFoto2" name="foto_2" onchange="previewImg(this, 'preview2')">
                  </label>
              </div>
          </div>
      </div>
      ...
      <div class="mb-3 row">
          <div class="col-sm-5"></div>
          <div class="col-sm-7">
              <div class="foto-container-3">
                  <!-- Preview foto 3 -->
                  <div class="preview-container">
                      <img class="preview" style="display: none;">
                  </div>
                  <!-- Tombol + -->
                  <label for="inputFoto3" class="plus-btn">
                      <i class="fas fa-plus"></i>
                      <input type="file" class="form-control d-none" accept=".png, .jpg, .jpeg" id="inputFoto3" name="foto_3" onchange="previewImg(this, 'preview3')">
                  </label>
              </div>
          </div>
      </div>
      ...
      <div class="mb-3 row">
          <div class="col-sm-5"></div>
          <div class="col-sm-7">
              <div class="foto-container-4">
                  <!-- Preview foto 4 -->
                  <div class="preview-container">
                      <img class="preview" style="display: none;">
                  </div>
                  <!-- Tombol + -->
                  <label for="inputFoto4" class="plus-btn">
                      <i class="fas fa-plus"></i>
                      <input type="file" class="form-control d-none" accept=".png, .jpg, .jpeg" id="inputFoto4" name="foto_4" onchange="previewImg(this, 'preview4')">
                  </label>
              </div>
          </div>
      </div>
      
        <div class="modal-footer" style="position: relative; bottom:200px;">
...
</script><?php /**PATH C:\xampp\htdocs\Lahada\resources\views/admin/modal/addModal.blade.php ENDPATH**/ ?>