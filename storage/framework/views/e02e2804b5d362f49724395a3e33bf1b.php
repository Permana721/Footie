<section id="header">
    ...
    <?php if(auth()->guard()->guest()): ?>
        ...
        <form action="<?php echo e(url('/search')); ?>" class="navbar-form">
            <input type="search" autocomplete="off" placeholder="Cari di LahAda" class="navbar-form-search" name="search" value="<?php echo e(Request::get('search')); ?>" aria-label="search" id="search-input">
            <button class="navbar-form-btn transparent-button" type="submit">
                <li><i class="fa-solid fa-magnifying-glass kaca"></i></li>
            </button>
        </form>
...
<?php /**PATH C:\xampp\htdocs\Footie\resources\views/pelanggan/componen/navbar.blade.php ENDPATH**/ ?>