        ...
        <div class="card p-4 m-auto" style="width: 30vw">
            ...
            <div class="card-body">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-7">
                        <input type="email" class="form-control" id="email" name="email" value="" autofocus>
                    </div>
                </div>
                <div class="mb-3 row">
...
</html><?php /**PATH D:\xampp\htdocs\Lahada\resources\views/admin/page/login.blade.php ENDPATH**/ ?>