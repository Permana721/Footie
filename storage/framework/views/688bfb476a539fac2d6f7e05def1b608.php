    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 id="modalTitle" class="modal-title fs-5" id="exampleModalLabel">Ganti Akun</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="<?php echo e(route('ganti.akun')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3 row">
                    ...
                    <button type="submit" class="btn btn-primary login mb-4">Ganti Akun</button>
...
<script src="<?php echo e(asset('/assets/js/custom.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\Lahada\resources\views/pelanggan/login/gantiAkun.blade.php ENDPATH**/ ?>