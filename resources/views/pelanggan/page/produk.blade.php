                            ...
                            @if ($comment->user_id === auth()->id())
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton-{{ $comment->id }}">
                                        <a class="dropdown-item edit-comment-btn" href="#" data-comment-id="{{ $comment->id }}">Edit</a>
                                ...
                                <form id="edit-comment-form-{{ $comment->id }}" class="edit-comment-form" action="{{ route('comments.update', $comment->id) }}" method="post" style="display: none;">
                                    @csrf
                                    @method('PUT')
