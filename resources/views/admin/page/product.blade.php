...
@section('content')
    <div class="card">
        <div class="card-body d-flex flex-row justify-content-between">
            ...
            <form action="{{ url('/admin/product') }}" method="get" class="form-inline">
    ...
    <div class="card rounded-full">
        <div class="card-body">
                    ...
                    @else
                        ...
                        @foreach ($data as $x)
                            <tr class="align-middle">
                                ...
                                <td>
                                    <img src="{{ $x->halal == 'halal' ? asset('assets/img/halal-haram/halal.png') : asset('assets/img/halal-haram/haram.png') }}" style="width: 80px" alt="">
                                </td>
                                <td>{{ $x->harga}}</td>
                                <td>{{ $x->quantity}}</td>
                                <td>
            ...
            <div class="pagination d-flex flex-row justify-content-between">
                <div class="showData">
                    Menampilkan {{ $data->count() }} produk dari total {{ $data->total() }} produk
                </div>
                <div>
                    {{ $data->links() }}
                </div>
