      ...
      <form action="{{route('updateData', $data->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-7">
              <textarea type="text" class="form-control" id="deskripsi" name="deskripsi" value="" style="height: 250px;">{{$data->deskripsi}}</textarea>
            </div>
          </div>
          <div class="mb-3 row">
            ...
            <div class="col-sm-7">
              <select class="form-control" id="category" name="category">
                ...
                <option value="chinese" {{$data->category == 'chinese' ? 'selected' : ''}}>Chinese Food</option>
                <option value="middle" {{$data->category == 'middle' ? 'selected' : ''}}>Middle Food</option>
                <option value="indonesia" {{$data->category == 'indonesia' ? 'selected' : ''}}>Indonesia Food</option>
                <option value="japan" {{$data->category == 'japan' ? 'selected' : ''}}>Japannese Food</option>
                <option value="korean" {{$data->category == 'korean' ? 'selected' : ''}}>Korean Food</option>
                <option value="non-halal" {{$data->category == 'non-halal' ? 'selected' : ''}}>Non Halal</option>
              </select>
            </div>
          </div>
          <div class="mb-3 row">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-7">
              <input type="text" class="form-control" id="alamat_penjual" name="alamat_penjual" value="{{$data->alamat_penjual}}">
            </div>
          </div>
          <div class="mb-3 row">
            ...
            <div class="col-sm-7">
              <select class="form-control" id="halal" name="halal">
                ...
                <option value="halal" {{$data->halal == 'halal' ? 'selected' : ''}}>Halal</option>
                <option value="haram" {{$data->halal == 'haram' ? 'selected' : ''}}>Haram</option>
              </select>
            </div>
          </div>
          <div class="mb-3 row">
            ...
            <div class="col-sm-7">
                <input type="text" class="form-control" id="harga" name="harga" value="{{$data->harga}}" oninput="formatRibuan(this)">
            </div>
        </div>
          ...
          <div class="col-sm-7">
              <div class="foto-container">
                  <div class="preview-container">
                      ...
                      <img src="{{ asset('storage/product/' . $data->foto) }}" class="preview" style="width: 40%; height: auto; display: block;" onclick="selectNewImage()">
